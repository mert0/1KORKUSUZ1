...
exports.run = (client, message, args) => {
  if (message.author.id != "689438123482284118") if (message.author.id != "453634830056423424") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  .setColor('RANDOM')
  .setTitle(`**SAHİBİMDEN GELEN MESAJ**`)
  .setTimestamp()
